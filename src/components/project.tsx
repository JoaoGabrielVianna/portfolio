const projects = [
  {
    name: 'VidiNine',
    description: 'Plataforma de e-commerce modular construída com Golang, React, PostgreSQL e Docker, utilizando microserviços para garantir flexibilidade e escalabilidade.',
